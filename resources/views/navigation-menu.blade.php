            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @hasanyrole('SUPER USUARIO|ADMINISTRADOR GENERAL|ADMINISTRADOR DE SEDE')
                        ...
                        <!-- Dropdown for Catalogs and Configurations -->
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                class="inline-flex items-center px-3 py-2 mt-4 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-gray-800 hover:text-white transition ease-in-out duration-150">
                                {{ __('Configuración') }}
                                <svg :class="open ? 'rotate-180' : 'rotate-0'"
                                    class="ms-2 -me-0.5 size-4 transition-transform duration-200"
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                class="absolute z-50 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg">
                                <ul class="py-1 text-gray-200 text-sm">

                                    @hasanyrole('SUPER USUARIO|ADMINISTRADOR GENERAL')
                                        <li>
                                            <a href="{{ route('companies.index') }}" class="block px-4 py-2 hover:bg-gray-700">
                                                {{ __('Companies') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('unit-colors.index') }}"
                                        ...
                                        <li>
                                            <a href="{{ route('observation-types.index') }}"
                                                class="block px-4 py-2 hover:bg-gray-700">
                                    ...
                                    @hasanyrole('SUPER USUARIO|ADMINISTRADOR GENERAL|ADMINISTRADOR DE SEDE')
                                        <li>
                                            <a href="{{ route('users.index') }}" class="block px-4 py-2 hover:bg-gray-700">
                                                {{ __('Users') }}
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    @hasanyrole('SUPER USUARIO')
                                        ...
                                        <li>
                                            <a href="{{ route('roles.index') }}" class="block px-4 py-2 hover:bg-gray-700">
                                                {{ __('Roles') }}
                                            </a>
                                        </li>
                                    @endhasanyrole
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200 dark:text-gray-400 bg-gray-800 dark:bg-gray-800 hover:text-white dark:hover:text-gray-300 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-700 active:bg-gray-700 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @hasanyrole('SUPER USUARIO|ADMINISTRADOR GENERAL|ADMINISTRADOR DE SEDE')
                ...
                <!-- Dropdown for Catalogs & Configurations -->
                <div x-data="{ open: false }">
                    <button @click="open = !open"
                        class="w-full flex items-center px-4 py-2 text-start text-base font-medium text-gray-400 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out">
                        {{ __('Configuración') }}
                        <svg :class="open ? 'rotate-180' : 'rotate-0'"
                            class="ms-2 -me-0.5 size-4 transition-transform duration-200"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
